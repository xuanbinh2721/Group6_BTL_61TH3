...
<form action="./processChangePassword.php?id=<?php echo $row['id'];?>" method="POST">
        <table class="tbl-30 mb-3">
            ...
            <tr>
                <td>New Password:</td>
                <td>
                    <input type="password" name="new_password" id="npwd" placeholder="" onchange='check_pass();'>
                </td>
            </tr>
            <tr>
                <td>Confirm Password: </td>
                <td>
                    <input type="password" name="confirm_password" id="cnpwd" placeholder="" onchange='check_pass();'>
                </td>
            </tr>
        </table>
