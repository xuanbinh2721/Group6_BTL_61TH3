...
<head>
  ...
  <script src="/Group6_BTL_61TH3/home/js/home.js"></script>
  <title>Edmodo</title>
</head>
<body>
<a href="./view_student.php" class ="btn btn-warning ms-5 mt-5"> Back </a>
<h3 class ="text-center mt-5">Change Password</h3>

<main class = "d-flex justify-content-center">
<form action="./processChangePwStd.php?id=<?php echo $row['id'];?>" method="POST">
