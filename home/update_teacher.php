...
?>
<main>
    <a href="./view_teacher.php" class ="btn btn-warning ms-5 mt-2"> Back </a>
    <div class="container">
        <h3 class="text-center text-dark mt-5">Cập nhật thông tin giáo viên</h3>
        <!-- Form thêm Dữ liệu nhân viên -->
        <form action="ProcessUpdateteacher.php?id=<?php echo $row['id']; ?>" method="post">
