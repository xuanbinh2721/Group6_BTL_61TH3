...
<body>
        ...
        <div class="row">
            <nav class="fixed-top navbar navbar-expand-lg navbar-light bg-light">
                <div class="container-fluid">
                    <a class="navbar-brand" href="./teacher_index.php">
                    ...
                    <div class="sub-menu-header collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mb-2 mb-lg-0">
                            <li class="nav-item">
                                <a class="nav-link" aria-current="page" href="./teacher_index.php">
    ...
    <main class="container-fluid main">
        <div class="profile-contain">
            <div class="avatar">
                <a href="">
                    <img class="img-fluid rounded-circle img-home" src ="./upload/<?php echo $row['teacher_img'] ?>">
                </a>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="processUpAvtTeacher.php?id=<?php echo $row['id']; ?>" method = "post" enctype = "multipart/form-data">
                                    <div class="mb-3">
                ...
                <table class="table">
                    ...
                    <tbody>
                        <?php
                            ...
                            $id = $_SESSION['id'];
                            $sql1 = "SELECT t.full_name, t.sex, t.date_of_birth FROM teacher t Where iduser = '$id'";
            ...
            <div class="menu">
                <a type="button" class="btn btn-warning" style="width: 200px ; display: block" href="./add-teacher.php">Thêm</a>
                <a type="button" class="btn btn-warning" style="width: 200px ; display: block" href="./update_teacher.php">Sửa</a>
                <!-- <button type="button" class="btn btn-warning" disabled>Xóa</button> -->
            </div>              
        </div>  

        <nav>
            <div class="nav nav-tabs mt-5" id="nav-tab" role="tablist">
                <button class="nav-link active" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home" type="button" role="tab" aria-controls="nav-home" aria-selected="true">Bài giảng</button>
                ...
                <button class="nav-link" id="nav-contact-tab" data-bs-toggle="tab" data-bs-target="#nav-contact" type="button" role="tab" aria-controls="nav-contact" aria-selected="false">Lịch dạy</button>
            </div>
        </nav>
